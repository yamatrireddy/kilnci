...
UPDATE runners
SET prev_cert_serial = cert_serial, cert_serial = sqlc.arg(new_serial), cert_der = sqlc.arg(cert_der),
    cert_spki_sha256 = sqlc.arg(cert_spki_sha256), cert_renewed_at = sqlc.arg(now), cert_expires_at = sqlc.arg(expires_at)
